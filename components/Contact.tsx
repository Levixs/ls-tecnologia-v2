    ...
    return (
        <section id="contact" className="relative py-20 overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-900/35 to-transparent" />
                <div className="absolute inset-0 opacity-5 bg-[linear-gradient(to_right,#10b98108_1px,transparent_1px),linear-gradient(to_bottom,#10b98108_1px,transparent_1px)] bg-[size:40px_40px]" />

                {/* Subtle animated elements */}
                <div className="absolute top-1/3 right-1/3 w-32 h-32 bg-emerald-500/8 rounded-full blur-xl animate-pulse" style={{ animationDuration: '10s' }} />
                <div className="absolute bottom-1/3 left-1/4 w-24 h-24 bg-teal-500/8 rounded-full blur-xl animate-pulse" style={{ animationDuration: '8s', animationDelay: '5s' }} />
            </div>
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    id="name"
                                    name="name"
                                    className="w-full px-4 py-2 bg-gray-800/40 backdrop-blur-sm border border-gray-600/40 rounded-lg text-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500/50 transition-colors"
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    name="message"
                                    rows={4}
                                    className="w-full px-4 py-2 bg-gray-800/40 backdrop-blur-sm border min-h-24 h-24 border-gray-600/40 rounded-lg text-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500/50 transition-colors"
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/40">
